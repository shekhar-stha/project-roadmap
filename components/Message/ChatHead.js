...
export default function ChatHead({ endUser, openSlideover }) {
  return (
    <div className='flex sticky top-[80px] bg-white z-20 items-center justify-between sm:px-5 px-5  sm:pe-15  chat-head shadow-6 border-b-2 border-stroke dark:border-none dark:bg-boxdark'>
